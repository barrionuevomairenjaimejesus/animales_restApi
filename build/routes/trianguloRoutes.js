    ...
    constructor() {
        this.getTriangulos = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.conectarBD()
                ...
                console.log(mensaje);
                const query = yield Animal_1.Triangulos.find();
                console.log(query);
                res.json(query);
            }))
                .catch((mensaje) => {
        ...
        this.nuevoTrianguloPost = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(dSchema);
            const oSchema = new Animal_1.Triangulos(dSchema);
            yield database_1.db.conectarBD();
            yield oSchema.save()
                .then((doc) => {
        ...
        this.getArea = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.db.conectarBD()
                .then((mensaje) => __awaiter(this, void 0, void 0, function* () {
                console.log(mensaje);
                yield Animal_1.Triangulos.findOne({ _nombre: { $eq: nombre } }, (error, doc) => {
                    if (error) {
                        console.log(error);
                        ...
                        if (doc == null) {
                            ...
                            triangulo =
                                new Animal_1.Triangulo(doc._nombre, doc._base, doc._lado2, doc._lado3);
        ...
        this.getAreav2 = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.db.conectarBD()
                .then((mensaje) => __awaiter(this, void 0, void 0, function* () {
                console.log(mensaje);
                const query = yield Animal_1.Triangulos.findOne({ _nombre: nombre });
                if (query == null) {
                    console.log(query);
                    res.json({});
                }
                else {
                    const triangulo = new Animal_1.Triangulo(query._nombre, query._base, query._lado2, query._lado3);
        ...
        this.getDelete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { nombre } = req.params;
            yield database_1.db.conectarBD();
            yield Animal_1.Triangulos.findOneAndDelete({ _nombre: nombre }, (err, doc) => {
                if (err)
                    console.log(err);
                else {
                    if (doc == null) {
        ...
        this.getAreas = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (dTriangulo of query) {
                tmpTriangulo =
                    new Animal_1.Triangulo(dTriangulo._nombre, dTriangulo._base, dTriangulo._lado2, dTriangulo._lado3);
        ...
        this.actualiza = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.db.conectarBD();
            yield Animal_1.Triangulos.findOneAndUpdate({ _nombre: nombre }, {
                _nombre: nombre,
                _base: base,
                _lado2: lado2,
                _lado3: lado3,
